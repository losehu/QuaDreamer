...
def calculate_fvd(videos1, videos2, device, i3d,method='styleganv', only_final=False):

    if method == 'styleganv':
        from common_metrics_on_video_quality.fvd.styleganv.fvd import get_fvd_feats, frechet_distance, load_i3d_pretrained
    elif method == 'videogpt':
        from common_metrics_on_video_quality.fvd.videogpt.fvd import load_i3d_pretrained, frechet_distance
