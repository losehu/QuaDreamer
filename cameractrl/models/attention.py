...
from cameractrl.svd.attention import TemporalBasicTransformerBlock, _chunked_feed_forward
from diffusers.utils.torch_utils import maybe_allow_in_graph
import os
add_obj_attn1 = os.getenv('ADD_OBJ_ATTN1')
if add_obj_attn1 == 'true' or add_obj_attn1 == 'True':
    add_obj_attn1 = True
else:
    add_obj_attn1 = False 
...
class TemporalPoseCondTransformerBlock(TemporalBasicTransformerBlock):
    ...
    def forward(
        ...
        if add_obj_attn1:
            attn_output = self.attn1(norm_hidden_states, encoder_hidden_states=None, pose_feature=pose_feature)#PoseAdaptorAttnProcessor
        else:
        ...
        if self.attn2 is not None:
            ...
            attn_output = self.attn2(norm_hidden_states, encoder_hidden_states=encoder_hidden_states, pose_feature=pose_feature)#XFormersAttnProcessor
            hidden_states = attn_output + hidden_states
